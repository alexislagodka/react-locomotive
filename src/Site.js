...
export default function Site() {
  ...
  <>
        <nav className='w-screen z-50 fixed top-0 flex flex-row justify-end'>
            ...
            <li><a href='javascript:void(0)' onClick={(e) => goToTop(e, firstSectionRef)}>First</a></li>
            <li><a href='javascript:void(0)' onClick={(e) => goTo(e, secondSectionRef)}>Second</a></li>
            <li><a href='javascript:void(0)' onClick={(e) => goTo(e, thirdSectionRef)}>Third</a></li>
            <li><a href='javascript:void(0)' onClick={(e) => goTo(e, fourthSectionRef)}>Fourth</a></li>
            <li><a href='javascript:void(0)' onClick={(e) => goTo(e, fifthSectionRef)}>Fifth</a></li>
            </ul>
        </nav>
